...
function portfolioIsotope() {
   ...
   if(dataFilter==".branding")
	 {
    document.getElementById("botonbranding").src="images/portafolio/Botones/1_2.png";
	document.getElementById('oculto').style.display = 'block';
  }
	else {  document.getElementById("botonbranding").src="images/portafolio/Botones/1.png"; document.getElementById('oculto').style.display = 'none';}
	if(dataFilter==".social")
	{
	 document.getElementById("botonsocial").src="images/portafolio/Botones/2_2.png";
 }
 	else {document.getElementById("botonsocial").src="images/portafolio/Botones/2.png";}
 if(dataFilter==".web")
 {
	document.getElementById("botonweb").src="images/portafolio/Botones/3_2.png";
}
else {document.getElementById("botonweb").src="images/portafolio/Botones/3.png";}
...
function lightboxGallery() {
	$( ".lightbox-gallery-branding" ).magnificPopup({
		type: 'image',
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-social" ).magnificPopup({
		type: 'image',
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-web" ).magnificPopup({
		type: 'image',
		gallery:{
			enabled: true
		},
...
function lightboxGalleryClientes() {
	$( ".lightbox-gallery-clientes-1" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-2" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-3" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-4" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-5" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-6" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-7" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-8" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-9" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-10" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-11" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-12" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-13" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-14" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-15" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-16" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
	...
	$( ".lightbox-gallery-clientes-17" ).magnificPopup({
		type: "image",
		gallery:{
			enabled: true
		},
...
function contactFormValidation() {
	...
	var errorMsgData = $( ".cf-notifications" ).data( "error-msg" ),
		errorMsgDefault = 'Complete los campos requeridos.',
...
function cfSubmitForm(){
    ...
    var message = $( "#cfMessage" ).val();
		var number = $( "#cfNumber" ).val();
		var asunto = $( "#cfAsunto" ).val();

    $.ajax({
        type: "POST",
        url: "./php/Email.php",
        data: "cfName=" + name + "&cfEmail=" + email + "&cfMessage=" + message + "&cfNumber=" + number + "&cfAsunto=" + asunto,
